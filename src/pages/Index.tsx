...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-slate-900 to-slate-800 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Company Info */}
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-2xl font-bold mb-4 bg-gradient-tropical bg-clip-text text-transparent">
                AI Travel Concierge
              </h3>
              <p className="text-gray-300 mb-6 max-w-md">
                Your personal AI-powered travel assistant helping you discover amazing destinations
                and plan perfect journeys tailored to your preferences.
              </p>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-gray-400">
              © 2024 AI Travel Concierge. All rights reserved. Made with ❤️ for travelers worldwide.
            </p>
          </div>
        </div>
      </footer>
